...
void main() {
  test('encodePhoneGpsSample packs lat/lon/accuracy/seq/utc into 15 bytes', () {
    final bytes = encodePhoneGpsSample(
        37.7749295, -122.4194155, 12.5, 42, 1789732770);
